...
const perguntaRespostaController = require("../controllers/pergunta-resposta.controller");
...
router.get("/pergunta/:id/respostas", middleware.checkToken, perguntaRespostaController.getQuestionAnswers);
